...
💡 *Note:* Only authorized users can access the bot. Contact @NB_Luis for authorization.
...
You are not authorized to use this bot. Please contact @NB_Luis for authorization.
        """
